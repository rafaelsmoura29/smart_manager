...
# Definindo os pinos de LED (somente pinos 23 e 29)
led_pins = [23, 29]
...
led_sequencia = "00"  # Sequência inicial para dois LEDs
...
def aleatorio():
    global led_sequencia
    while True:
        sequencia_ale = ''.join(random.choice("01") for _ in range(2))  # Gerando sequência de 2 bits
